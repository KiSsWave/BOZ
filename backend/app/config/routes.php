...
return function (\Slim\App $app): \Slim\App {
    ...
    $app->group('user', function () use ($app) {
        ...
        $app->patch('/tickets', boz\application\action\TakeTicketByAdminAction::class)->add(boz\application\middleware\AuthzUserMiddleware::class);
        $app->get('/tickets/{adminId}', boz\application\action\GetTicketByAdminIdAction::class)->add(boz\application\middleware\AuthzUserMiddleware::class);
        $app->get('/ticket/{userId}', boz\application\action\GetTicketByUserIdAction::class)->add(boz\application\middleware\AuthzUserMiddleware::class);
        $app->patch('/tickets/close/{ticketId}', boz\application\action\CloseTicketAction::class)->add(boz\application\middleware\AuthzUserMiddleware::class);
