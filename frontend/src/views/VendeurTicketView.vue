<template>
  <div>
    ...
    <div class="contact-container">
      ...
      <div v-if="loadingticket" class="loading">
        <p>Chargement de vos tickets...</p>
      </div>

      <div v-else-if="errorticket" class="error">
        <p>{{ error }}</p>
      </div>
...
export default {
  ...
  setup() {
    ...
    const loadingticket = computed(() => appStore.loadingStates.userTickets);
    const errorticket = computed(() => appStore.errorStates.userTickets);
